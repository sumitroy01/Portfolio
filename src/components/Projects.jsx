        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="rounded-2xl bg-gray-900/60 border border-gray-800 p-6 shadow-md">
            ...
            <div className="flex items-center gap-4 mt-4">
              <a
                href="https://your-donation-app.com"
                target="_blank"
                rel="noreferrer"
              ...
              <a
                href="https://github.com/your-donation-app"
                target="_blank"
                rel="noreferrer"
          ...
          <div className="rounded-2xl bg-gray-900/60 border border-gray-800 p-6 shadow-md">
            ...
            <div className="flex items-center gap-4 mt-4">
              ...
              <a
                href="https://github.com/your-chat-app"
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-1 text-gray-300 hover:text-white text-sm transition"
              >
          ...
          <div className="rounded-2xl bg-gray-900/60 border border-gray-800 p-6 shadow-md lg:col-span-2">
            ...
            <div className="flex items-center gap-4 mt-4">
              ...
              <a
                href="https://github.com/your-devops-pipeline"
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-1 text-gray-300 hover:text-white text-sm transition"
              >
