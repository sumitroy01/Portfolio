      ...
      <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center gap-10 md:gap-16">
        ...
        <div className="w-full md:w-2/3">
          ...
          <p className="text-gray-400 text-sm sm:text-base leading-relaxed mb-6">
            I&apos;ve built projects like a real-time chatting app and a
            donation app. I&apos;m comfortable working as a Software Engineer,
            MERN developer, or DevOps-focused engineer using tools like Docker,
            Kubernetes, Linux, AWS, Git, Postman and Jenkins, with strong DSA
            skills in Java.
          </p>

          {/* FOCUSED, INDUSTRY-RELEVANT SKILLS */}
          <div className="mb-7">
